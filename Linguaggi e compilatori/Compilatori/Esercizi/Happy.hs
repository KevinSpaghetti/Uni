...
happyExpList = Happy_Data_Array.listArray (0,74) ([36096,4096,4096,0,0,0,0,0,0,256,9216,36866,8,64,16,8,0,0,512,13312,53250,16392,34,0,256,0,0,8192,13312,2,16388,34,0,548,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Let","Expr","Match","Identifier","Application","id","'='","'let'","'case'","'of'","'in'","'->'","'('","')'","%eof"]
        bit_start = st * 18
        bit_end = (st + 1) * 18
...
action_5 (12) = happyReduce_12
action_5 (13) = happyReduce_12
action_5 (14) = happyReduce_12
action_5 (15) = happyReduce_12
action_5 (16) = happyReduce_12
action_5 (17) = happyReduce_12
action_5 (18) = happyReduce_12
...
happyReduction_8 ((HappyAbsSyn5  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 ((Match happy_var_2 happy_var_4) : happy_var_1
	) `HappyStk` happyRest
...
happyReduction_10 (HappyTerminal (TokenIdentifier happy_var_1))
	 =  HappyAbsSyn7
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenIn -> cont 14;
	TokenArrow -> cont 15;
	TokenRoundOpen -> cont 16;
	TokenRoundClosed -> cont 17;
	_ -> happyError' ((tk:tks), [])
	}
...
data Match = Chain Match Match 
                | Match Expr Expr deriving (Show)
